package com.mietrix.quranprojects;
...
public class App extends Application {
  ...
  //        if (!loadedFont.equals(config.fontArabic) ||
  // !loadedFontSize.equals(config.fontSizeArabic)) {
  //
  //            try {
  //
  //                Log.e("App: config.fontArabic", loadedFont + " " + config.fontArabic + " size: "
