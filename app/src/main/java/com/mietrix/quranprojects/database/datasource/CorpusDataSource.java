...
public class CorpusDataSource {
  ...
  public Corpus getCorpusById(long id) {
    ...
    cursor =
        db.rawQuery(
            "SELECT quran_corpus.root,quran_corpus.arabic1,quran_corpus.arabic2,quran_corpus.arabic3,quran_corpus.arabic4,quran_corpus.arabic5 ,quran_corpus.word_type_id1,quran_corpus.word_type_id2 from quran_corpus where quran_corpus._id = "
                + id,
            null);
